  ...
  return (
    <div className="min-h-screen bg-[#f7f2ee] p-6">
      <div className="mx-auto max-w-2xl rounded-2xl border border-[#e0c0b1] bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-[#191c1e]">Nao foi possivel carregar os relatorios.</h1>
        <p className="mt-3 text-sm leading-6 text-[#4f5f7a]">Tente novamente em alguns instantes.</p>
