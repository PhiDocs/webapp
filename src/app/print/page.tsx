      ...
      <div className="print-container">
        <header className="flex items-start justify-between p-8 border-b">
          <div className="flex items-center gap-4">
            ...
            <div>
                 <h1 className="text-xl font-bold text-gray-800">{data.companyName}</h1>
          ...
          <section className="mb-4">
            <h3 className="section-title text-center">RESPONSÁVEL PELO ACOMPANHAMENTO DOS SERVIÇOS</h3>
             <table className="w-full border-collapse border mt-1">
              ...
              <tbody>
                <tr>
                  <td className="border p-2 h-12">{data.responsibleName}</td>
                  <td className="border p-2">{data.responsibleRole}</td>
               ...
               <table className="w-full border-collapse border mt-1">
                <thead>
                 ...
                 <tbody>
                    ...
                    {Array.from({ length: 5 - data.teamMembers.split(',').length }).map((_, index) => (
                      <tr key={`empty-${index}`}>
                        <td className="border p-2 h-10"></td>
                        <td className="border p-2"></td>
                        <td className="border p-2"></td>
