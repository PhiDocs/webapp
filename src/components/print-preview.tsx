        ...
        <main className="p-8 flex-grow flex flex-col">
          ...
          <section className="mb-4">
            <h3 className="section-title text-center">RESPONSÁVEL PELO ACOMPANHAMENTO DOS SERVIÇOS</h3>
             <table className="w-full border-collapse border mt-1">
               <thead>
                <tr>
                  <th className="border p-2 text-left w-[40%]">NOME</th>
                  <th className="border p-2 text-left w-[30%]">FUNÇÃO</th>
                  <th className="border p-2 text-left w-[30%]">ASSINATURA</th>
                </tr>
              </thead>
              <tbody>
          ...
          {analysisData?.proceduralSteps && analysisData.proceduralSteps.length > 0 ? (
            <section className="mb-4" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
              ...
              <table className="w-full border-collapse border mt-1 text-xs">
                <thead>
                  <tr>
                    <th className="border p-1 text-left w-[5%]">ITEM</th>
                    <th className="border p-1 text-left w-[25%]">ATIVIDADES (Com suas respectivas etapas/passos)</th>
                    <th className="border p-1 text-left w-[25%]">RISCOS POTENCIAIS (O que poderá sair errado)</th>
                    <th className="border p-1 text-left w-[45%]">MEDIDAS PREVENTIVAS / RECOMENDAÇÕES DE SEGURANÇA (Evitar o acidente ou minimizar os danos, caso este ocorra)</th>
                  </tr>
                </thead>
                <tbody>
                  {analysisData.proceduralSteps.map((step, index) => (
                    <tr key={index}>
                      <td className="border p-2 align-top text-center">{step.item}</td>
                      <td className="border p-2 align-top whitespace-pre-wrap">{step.activity}</td>
                      <td className="border p-2 align-top whitespace-pre-wrap">{step.potentialRisks}</td>
                      <td className="border p-2 align-top whitespace-pre-wrap">{step.preventiveMeasures}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section className="mt-auto pt-8" style={{breakBefore: 'page'}}>
